...
description: "Learn how to authenticate with World Lens APIs using API keys and tokens"
---
...
1. **Register an Account**: Visit [https://api.worldlens.co/auth/register](https://api.worldlens.co/auth/register) to create your account
